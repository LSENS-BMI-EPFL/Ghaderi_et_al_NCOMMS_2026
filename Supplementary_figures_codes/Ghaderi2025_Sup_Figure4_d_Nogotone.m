...
params.TrialType = [3];  % 1: gotone/whisker, 2: gotone/nowhisker, 3: nogotone/whisker, 4: nogotone/nowhisker, 5: notone/whisker
params.LickState = [0];  % 1: lick, 0: nolick
...
trialnumber=150; % trial to be plotted
