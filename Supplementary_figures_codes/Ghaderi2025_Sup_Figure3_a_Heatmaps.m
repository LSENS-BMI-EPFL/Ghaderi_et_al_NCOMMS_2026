...
trialtype_list = [1, 2, 3, 4, 5];  % All trial types [1, 2, 3, 4, 5]
trialname_list = {'Gotone_Whisker'; 'Gotone'; 'Nogotone_Whisker'; 'Nogotone'; 'Whisker'};
...
for ind_trialtype = 1:length(trialtype_list)
    ...
    for ind_area = 1:length(region_list)
        ...
        All_Area_Delta_Performance.(current_trialtype_name).(current_area)=performance;
