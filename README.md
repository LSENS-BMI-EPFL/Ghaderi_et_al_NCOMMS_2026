...
| # | Folder | Contents |
|---|--------|----------|
| 1 | `data_electrophysiology` | High-density extracellular recordings with Neuropixels probes — one NWB file per session |
| 2 | `data_optogenetics` | Optogenetic inactivation sessions — one NWB file per session |
| 3 | `data_helpers` | Small data structures used in the analyses (these files need to be added and are not present in this repository) |
