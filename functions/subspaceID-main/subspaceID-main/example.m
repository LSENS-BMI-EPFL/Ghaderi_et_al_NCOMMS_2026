...
figure 
subplot(121)
plot(exampleData.time,mean(plt.null.ssm,2))
hold on
plot(exampleData.time,mean(plt.potent.ssm,2))
legend({'mov-null';'mov-potent'})
subplot(122)
plot(exampleData.time,mean(exampleData.motionEnergy,2),'k')
hold on
plot(exampleData.time,0*mean(exampleData.motionEnergy,2),'-.k')
