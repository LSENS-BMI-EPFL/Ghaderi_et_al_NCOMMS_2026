...
% =========================================================================
% 
% This script performs decoding analysis using potent movement subspace data
...
% on potent movement subspace data. It compares Go-tone with whisker and lick
% trials vs No-go-tone with whisker and no lick trials across different brain
% regions and time bins.
%
% Dependencies: 
...
% Output: Decoding accuracy results saved to Decoding_potent.mat
% =========================================================================
...
for ind_area = 1:length(params.regionlist)
    ...
    for ind_probe = list_probes
        ...
        %% Extract potent movement subspace data
        Currsig = mov_potent_null(ind_probe).potent;
...
save([directory 'Decoding_potent.mat'], "Accuracy", "Accuracy_shuffeled", "windowCenters", '-v7.3');
