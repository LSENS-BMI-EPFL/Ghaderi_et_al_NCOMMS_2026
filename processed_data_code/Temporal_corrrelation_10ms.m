%% =========================================================================
% Temporal_corrrelation_10ms.m
% =========================================================================
% 
% This script calculates temporal correlations between neural activity across
% different time bins for the manuscript "Contextual gating of whisker-evoked 
...
% different time bins for various trial conditions. It analyzes correlations
% between neural responses across time and compares them to shuffled data
% to assess the significance of temporal relationships.
%
% Dependencies: 
...
% Output: Temporal correlation analysis results saved to Temporal_corrrelation_10ms.mat
% =========================================================================
...
bin_width = 1;   % Window length (number of bins to concatenate)
...
for ind_cond = 1:length(params.TrialType)
    for ind_area = 1:length(params.regionlist)
        ...
        for ind_probes = list_probes
            ...
            % Optional: Concatenate time bins if bin_width > 1
            if bin_width ~= 1
                st = 1;
                en = bin_width;
                bin_flg = 1;
...
save([directory 'Temporal_corrrelation_10ms.mat'], "correlation_matrix", "angle_matrix", "correlation_matrix_shuffled", ...
