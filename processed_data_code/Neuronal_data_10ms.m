...
% for clustering analysis with 10ms temporal resolution for the manuscript 
...
fprintf('Processing neural data from %d brain regions...\n', length(params.regionlist));
...
save([directory 'Neuronal_data_10ms.mat'], "Neurons_activity_condition_area", "CCF_location", "CCF_xyz", ...
    "Depth", "Layer", "clustercounter", "Area", "Type", ...
    "windowCenters", "params", "session_info","Unit_ids");
