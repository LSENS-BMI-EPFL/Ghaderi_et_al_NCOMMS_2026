%% =========================================================================
% Decoding_training_on_prewhisk_All.m
% =========================================================================
%
% This script performs decoding analysis with training on pre-whisker
% stimulation data for all cell types for the manuscript "Contextual gating
...
% with a unique approach: it trains the classifier on pre-whisker stimulation
...
% activity can predict post-stimulus behavioral outcomes.
%
% Dependencies:
%   - psth_10ms.mat (contains trial data with 10ms bins)rng
...
% Output: Decoding accuracy results saved to Decoding_training_on_prewhisk_All.mat
% =========================================================================
...
params.celltype = 'All';           % Options: 'RS', 'FS', 'FS-RS', 'All'
...
save([directory 'Decoding_training_on_prewhisk_All.mat'], "Accuracy", "Accuracy_shuffeled", "windowCenters");
