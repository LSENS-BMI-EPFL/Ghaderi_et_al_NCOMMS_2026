...
% =========================================================================
% 
% This script processes NWB files to extract PSTH data with 5ms time bins
...
% calculates PSTHs with 5ms bins, identifies quiet trials, and organizes data
% into a structured format for further analysis. This version provides higher
% temporal resolution compared to the 10ms version.
%
% Dependencies: 
...
% Output: psth_5ms.mat containing processed PSTH data
% =========================================================================
...
% PSTH calculation parameters (5ms bins for higher temporal resolution)
[pre_time, post_time, bin_width, bin_step] = deal(-1, 2, 0.005, 0.005);  % Time windows and bin sizes
...
for ind_nwb = 1:length(nwb_file_address)
    ...
    % Calculate behavioral PSTHs (using 10ms bins for behavioral data)
    ...
    % Calculate piezo PSTH (using 5ms bins for neural data)
...
save([directory 'psth_5ms.mat'], "psth_mat", '-v7.3');
