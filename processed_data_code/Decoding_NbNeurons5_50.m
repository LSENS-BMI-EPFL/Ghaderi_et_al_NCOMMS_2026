%% =========================================================================
% Decoding_NbNeurons5_50.m
% =========================================================================
% 
% This script performs decoding analysis with varying numbers of neurons
% (5 to 50) for the manuscript "Contextual gating of whisker-evoked 
...
% with systematically varying numbers of neurons (5, 10, 15, ..., 50).
...
% performance as a function of population size.
%
% Dependencies: 
...
% Output: Decoding accuracy results saved to Decoding_NbNeurons5_50.mat
% =========================================================================
...
for ind_area = 1:length(params.regionlist)
    ...
    for ind_probe = list_probes
        ...
        NbNeurons_list = [5:5:50];  % Neuron counts: 5, 10, 15, ..., 50
...
save([directory 'Decoding_NbNeurons5_50.mat'], "Accuracy", "Accuracy_shuffeled", "windowCenters");
