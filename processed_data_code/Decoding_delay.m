...
% =========================================================================
% 
% This script performs decoding analysis with delay considerations for the
...
% with delay analysis. It analyzes neural responses across different time
% bins to assess how decoding performance changes with temporal delays
% between stimulus presentation and neural response.
%
% Dependencies: 
...
% Output: Decoding accuracy results saved to Decoding_delay.mat
% =========================================================================
...
save([directory 'Decoding_delay.mat'], "Accuracy", "Accuracy_shuffeled", "windowCenters");
