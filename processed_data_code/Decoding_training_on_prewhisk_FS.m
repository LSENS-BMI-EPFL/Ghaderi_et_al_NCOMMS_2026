%% =========================================================================
% Decoding_training_on_prewhisk_FS.m
% =========================================================================
% 
% This script performs decoding analysis with training on pre-whisker
% stimulation data for Fast Spiking (FS) cells only for the manuscript 
...
% focuses exclusively on Fast Spiking (FS) interneurons.
%
% Dependencies: 
...
% Output: Decoding accuracy results saved to Decoding_training_on_prewhisk_FS.mat
% =========================================================================
...
params.celltype = 'FS';           % Options: 'RS', 'FS', 'FS-RS', 'All' (set to 'FS' for this analysis)
...
for ind_area = 1:length(params.regionlist)
    ...
    for ind_probe = list_probes
        ...
        %% Determine cell type filter (FS cells only)
...
save([directory 'Decoding_training_on_prewhisk_FS.mat'], "Accuracy", "Accuracy_shuffeled", "windowCenters");
