...
parent = figure('Position', [200 200 800 400]);

h = tight_subplot(1,2,[0 .1],[.2 .1],[0.08 0.08]);
...
for ind_cond = 1:length(params.TrialType)
    ...
    plot(axs(ind_cond), [1.03 1.03],[-1 10], '--', 'Color', [0.5 0.5 0.5])
    ...
    ylabel(axs(ind_cond),'Evoked APs (Hz)');
